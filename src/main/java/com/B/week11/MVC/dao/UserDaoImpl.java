...
public class UserDaoImpl implements UserDao {
	  ...
	  public int register(User user) {
	    ...
	    String sql = "insert into user values(?,?,?,?,?,?,?,?)";
	     ...
	     jdbcTemplate.update(sql, new Object[] {user.getUsername(),  user.getPassword(), user.getRole(), user.getFirstname(),
	  ...
	  public User validateUser(Login login) {
	    String sql = "select * from user where user_name='" + login.getUsername() + "' and password='" + login.getPassword()
	        + "'";
